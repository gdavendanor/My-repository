...
\usepackage[papersize={5.5in,8.5in},left=1cm, right=1cm, top=1.7cm, bottom=1.5cm]{geometry}
\usepackage{mathexam}
\usepackage{amsmath}
\usepackage{pgf,tikz}
\usepackage{multicol}
...
\ExamName{``Nivelación Límites introducción"}
...
\draw[line width=1.6pt,color=ttqqff, smooth,samples=100,domain=2.05:3.5] plot(\x,{\x-2});
