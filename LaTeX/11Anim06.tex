...
\draw (0,0)--(0,1);
\draw (1,0)--(1,1);
\draw (0.5,0) ellipse (.5 and .15);
\draw (.5,1) ellipse (.5 and .15);
\draw[dashed] (0.5,0)--node[right]{$h$} (.5,1);
\draw[dashed] (0,0) --node[below] {$r$} (1,0);
\draw[dashed] (0,1)--(1,1);
\draw (2,0) ellipse (.5 and .15);
\draw (1.5,0)--(2,1);
\draw (2.5,0)--(2,1);
\draw[dashed] (2,0)--node[right]{$h$}(2,1);
\draw[dashed](1.5,0)--node[below]{$r$}(2.5,0);
\draw (3.5,.5) circle (.5);
\draw[dashed] (3.5,.5) ellipse(.5 and .15);
\draw[dashed,<->] (3.5,-.15)--(3.5,1.15);
\draw (3.5,.5)--node[above]{$r$}(3.75,.375);
\draw[dashed] (3.5,.5) ellipse (.15 and .5); 
\end{tikzpicture}
...
\foreach \x in {0,0.5}
\foreach \y in {0,0.5} \fill[black] (\x,\y) circle (3pt);
\node[below] at (0.25,-.25) {F1};
\fill[black] (0.25,.25) circle (3pt);
\foreach \x in {1.5,2}
\foreach \y in {0,0.5,1,1.5}\fill[black] (\x,\y) circle (3pt);
\fill[black] (1.75,.25) circle (3pt) (1.75,1.25) circle (3pt);
\node[below] at (1.75,-.25) {F2};
\foreach \x in {3,3.5}
\foreach \y in {0,0.5,1,1.5} \fill[black] (\x,\y) circle (3pt);
\foreach \x in {4,4.5}
\foreach \y in {0,.5} \fill[black] (\x,\y) circle (3pt);
\foreach \x in {3.25,4.25}
\fill[black] (\x,0.25) circle (3pt);
\node[below] at (3.75,-.25){F3};
\fill[black] (3.25,1.25) circle (3pt);
\foreach \x in {5.5,6,6.5,7}
\foreach \y in {0,0.5,1,1.5} \fill[black] (\x,\y) circle (3pt);
\foreach \x in {5.75,6.75}
\foreach \y in {.25,1.25} \fill[black] (\x,\y) circle (3pt);
\node[below] at (6.25,-0.25) {F4};
\end{tikzpicture} \hfill en F19
\item 
\begin{tikzpicture}[scale=.9]
\foreach \x in {0,0.5} \fill[black] (\x,.5) circle (3pt);
\node[below] at (0.25,0.25) {F1};
\foreach \x in {1.5,2} \foreach \y in {.5,1} 
\fill[black] (\x,\y) circle (3pt);
\node[below] at (1.75,0.25) {F2};
\foreach \x in {3,3.5,4,4.5}
\foreach \y in {0.5,1} \fill[black] (\x,\y) circle (3pt); \node[below] at (3.75,0.25) {F3};
\foreach \x in {5.5,6,6.5,7} \foreach \y in {0.5,1,1.5,2}
\fill[black] (\x,\y) circle (3pt);
\node[below] at (6.25,0.25) {F4};
\end{tikzpicture} \hfill en F6
\item 
\begin{tikzpicture}[scale=.9]
\foreach \x in {0,0.5}
\foreach \y in {0,.5} \fill[black] (\x,\y) circle (3pt) node[below] at (0.25,-0.25) {F1};
\foreach \x in {1.5,2}
\foreach \y in {0,0.5,1} \fill[black] (\x,\y) circle (3pt) node[below] at (1.75,-0.25) {F2};
\fill[black] (1.5,1.5) circle (3pt);
\foreach \x in {3,3.5,4}
\foreach \y in {0,0.5,1} \fill[black] (\x,\y) circle (3pt) node[below] at (3.5,-.25){F3};
\fill[black] (3,1.5) circle (3pt);
\foreach \x in {5,5.5,6,6.5}
\foreach \y in {0,0.5,1} \fill[black] (\x,\y) circle (3pt) node[below] at (5.75,-.25){F4};
\fill[black] (5,1.5) circle (3pt);
\end{tikzpicture} \hfill en F17
\item 
\begin{tikzpicture}[scale=.9]
\foreach \x in {0,.5} \fill[black] (\x,0) circle (3pt) node[below] at (0.25,-.25) {F1};
\foreach \x in {1.5,2} \foreach \y in {0,.5}
\filldraw[black] (\x,\y) circle (3pt) node[below] at (1.75,-.25){F2};
\foreach \x in {3,3.5,4} \foreach \y in {0,.5}
\fill[black] (\x,\y) circle (3pt) node[below] at (3.5,-.25){F3};
\foreach \x in {5,5.5,6,6.5} \foreach \y in {0,.5} \fill[black] (\x,\y) circle (3pt) node[below] at (5.75,-.25){F4};
\end{tikzpicture} \hfill en F31
