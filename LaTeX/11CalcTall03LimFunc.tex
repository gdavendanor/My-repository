...
\item $\displaystyle{\lim_{x\rightarrow 0}}h(x)$
\item $\displaystyle{\lim_{x\rightarrow 1}}h(x)$
...
expresa la longitud $L$ de un objeto como función de su velocidad $v$ con respecto a un observador, donde $L_{0}$ es la longitud del objeto en reposo y $c$ es la rapidez de la luz. Encuentre $\displaystyle{\lim_{v\rightarrow c}}L$ e interprete el resultado. Es necesario calcular el límite por izquierda?
\end{enumerate}
\end{document}
