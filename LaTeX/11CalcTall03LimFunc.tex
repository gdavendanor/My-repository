...
\item $\displaystyle{\lim_{x\rightarrow a}\dfrac{f(x)}{g(x)}}=\dfrac{\displaystyle{\lim_{x\rightarrow a}}f(x)}{\displaystyle{\lim_{x\rightarrow a}}g(x)} \text{ si } \displaystyle{\lim_{x\rightarrow a}g(x)\neq 0}$
\end{enumerate}
\end{document}
