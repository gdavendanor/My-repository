...
\item $\displaystyle{\lim_{x\rightarrow a}}x^{n}=a^{n}$ \hfill Para $n$ entero positivo
\item $\displaystyle{\lim_{x\rightarrow a}}\sqrt[n]{x}=\sqrt[n]{a}$ \hfill Para $n$ entero positivo y $a>0$
