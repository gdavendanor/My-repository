...
\end{enumerate}
Recuerde que para que pueda resolver límites donde se debe eliminar la indeterminación, es importante saber factorizar,  eliminar raíces multiplicando por la expresión conjugada etc. Es importante que Ud. repase estos temas por su cuenta correspondientes grados 8$^{\circ}$ 9$^{\circ}$.\\
