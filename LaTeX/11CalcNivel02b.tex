...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item $ (x+y)(p-q)=(p-q)(x+y) $ \underline{\hspace{6cm}}
    \item $ (C+D)(x+y)=(C+D)x+(C+D)y $ \underline{\hspace{6cm}}
  \end{enumerate}
...
\end{tikzpicture}
  ...
  \begin{enumerate}
    \item $ 5+\frac{3}{5}-\frac{1}{6}= $ \vspace{45pt}
    \item $ 0.25(\frac{5}{7}+\frac{2}{3})= $ \vspace{45pt}
    \item $ (\frac{3}{4}-\frac{2}{5})(\frac{1}{5}-\frac{1}{4})= $ \vspace{45pt}
    \item $ \dfrac{4-\frac{2}{5}}{\frac{1}{4}-\frac{1}{3}}= $ \vspace{45pt}
  \end{enumerate}
  \item Ubique el símbolo correcto ($<$ ,$>$, o $=$) en el espacio:
  \begin{enumerate}\begin{multicols}{2}
    \item $ 6 $ \underline{\hspace{.7cm}} $ \frac{17}{3} $
    \item $ \frac{2}{3} $ \underline{\hspace{.7cm}} $ 0.66 $
    \item $ -4 $ \underline{\hspace{.7cm}} $ -\frac{15}{4} $
    \item $ |-0.75| $ \underline{\hspace{.7cm}} $ |0.75| $
    \end{multicols}
  \end{enumerate}
