...
\item[4.] Hallar el valor de $x$, \qquad $\dfrac{9}{x}=\dfrac{27}{6}$
\end{enumerate}
...
\[\text{Sí} \qquad \dfrac{a}{b}=\dfrac{c}{d}, \qquad \text{entonces} \qquad \dfrac{a+b}{b}=\dfrac{c+d}{d} \]
\subsubsection*{Aplicaci\'{o}n de la cuarta propiedad}
\begin{enumerate}
\item[5.] Verificar la cuarta propiedad y al finalizar verificar si forman una proporción, \qquad $\dfrac{4}{7}=\dfrac{12}{21}$
