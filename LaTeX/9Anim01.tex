...
\usepackage{fancyhdr}
<<<<<<< HEAD
\usepackage[papersize={5.5in,8.5in},left=1cm,right=1cm,top=1.5cm, bottom=1.25cm]{geometry}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhead[LE]{gavendanor@colarborizadorabaja.edu.co}
=======
\usepackage{marvosym}
...
>>>>>>> b4dd80b1eb22623ef07f4fdbc80c4114dbb801df
\fancyhead[RE]{}
...
Resuelva cada una de las preguntas con el procedimiento requerido en su cuaderno (\emph{No raye ni dañe esta hoja}). Luego ubique las respuestas en un plano de $10\times 10$ con puntos numerados del 0-99.
\begin{enumerate}
\item El doble del quinto n\'{u}mero primo
\item El noveno n\'{u}mero primo
\item La longitud ($x$) de un rect\'{a}ngulo cuyo per\'{i}metro es 102 y cuya longitud (largo) es el doble del ancho.
