...
\fullwidth{\large \textbf{Probabilidad}}
\uplevel{
\begin{tabular}{|l|c|}
\hline 
...
\begin{choices}
\choice \includegraphics[scale=.75]{Images/RespA.png}
\choice \includegraphics[scale=.75]{Images/RespB.png}
\CorrectChoice \includegraphics[scale=.75]{Images/RespC.png}
\choice \includegraphics[scale=.75]{Images/RespD.png}
\end{choices}
