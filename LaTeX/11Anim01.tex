...
\emph{La solución a esta actividad debe ser entregada al finalizar la clase a las estudiantes Danna Paola Garzón o Paula Andrea Vargas para que ellas a su vez la entreguen a la coordinadora Melba Lucía Vera en una hoja, con el plano hecho y los respectivos procedimientos. Recuerde que debe dibujar 100 puntos que van numerados del 1-100}
\section{Animaplano}
...
\begin{tikzpicture}
 ...
 \draw (1,-1)--(1,0)--(2,0)--(3,-1)--(4,-3)--(5,-4)--(6,-4)
 --(6,-2)--(10,0)--(7,-3)--(7,-5)--(8,-7)--(10,-9)--(9,-9)
 --(7,-7)--(5,-6);
\end{tikzpicture}
\end{center}
\end{document}
