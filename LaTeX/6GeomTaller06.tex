...
\begin{center}
\includegraphics[scale=1]{Images/regla.png} 
\end{center}
...
\end{itemize}
Para medir longitudes mayores que el metro se utilizan unidades más grandes llama-
das múltiplos del metro.
Un decámetro equivale a diez metros. 1 dam = 10 m
Un hectómetro es igual a cien metros. 1 hm = 10 dam = 100 m
Un kilómetro equivale a mil metros. 1 km = 10 hm = 100 dam = 1 00
