...
Observe que en el tercer caso, el polinomio puede ser factorizado nuevamente, porque el factor $3x+12$ posee un factor común que es 3. Así mismo en el segundo caso, el binomio $(x^{2}+4x)$ puede ser factorizado, ya que $x$ es factor común a los dos términos.
\end{enumerate}
\section*{Taller}
