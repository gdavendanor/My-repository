...
\end{itemize}
\begin{enumerate}
\item[a.] $\overleftrightarrow{AB}$ es paralela a $\overleftrightarrow{DE}$ (\;)
\end{enumerate}
	
b.	b. La recta FC pasa también por el punto O.( )	
c.	c. El ángulo BOD es recto.( )	
d.	d. El ángulo FOA es agudo.( )	
e.	e.El polígono tiene forma de pentágono.( )	
