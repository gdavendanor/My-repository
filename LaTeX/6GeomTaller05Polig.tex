...
\begin{minipage}{.35\textwidth}
\begin{tikzpicture}
\filldraw[gray!35](-1,1)node[black,left]{G]--(1,1)node[right,black]{F}--(0,2)node[above,black]{O}--(-1,1)--(-.1,0)node[black,below left]{D}--(0,2)--(.1,1)node[black,below right]{E}--(0,2);
\end{tikzpicture}
\end{minipage}
