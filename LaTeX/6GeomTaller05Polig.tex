...
\begin{tikzpicture}
\filldraw[gray!15] (0,0)node[black,below]{B}--(2,2)--(0,4)node[left,black]{A}--(-2,2)--cycle;
\draw[gray!30] (0,0)--(0,4);
\draw[gray!30](-2,2)--(2,2);
\node[left] at (0,2){O};
\end{tikzpicture}
\end{minipage}
...
\begin{minipage}{.35\textwidth}
\begin{tikzpicture}
\filldraw[gray!15] (-2,2)node[left,black]{D}--(-1,3)--(1,3)--(2,2)node[right,black]{E}--(1,1)--(-1,1)--cycle;
\draw[gray!30](-2,2)--(0,2)--(-1,3)--(0,2)node[black,left]{O}--(1,3)--(0,2)--(2,2)--(0,2)-- (1,1)--(0,2)--(-1,1);
\end{tikzpicture}
\end{minipage}

\begin{minipage}{.35\textwidth}
\begin{tikzpicture}
\filldraw[gray!20](-2,2)node[above,black]{D}--(0,2)node[above,black]{O}--(2,2)node[above,black]{E}--(1,1)node[below,black]{F}--(-1,1)node[below,black]{G}--cycle;
\draw[gray!40](0,1)--(0,2);
\end{tikzpicture}
\end{minipage}
\begin{minipage}{.6\textwidth}
\begin{itemize}
