...
\usepackage{multicol}
\usepackage{subfig}
\usepackage[papersize={6.5in,8.5in},width=5.65in,height=7.1in]{geometry}
...
Venezuela & 5.64 \\ 
\hline 
\end{tabular}\footnote{Datos promedio según la Comisión Económica para América Latina y el Caribe (CEPAL) en el período 2010-2013}
\end{center}
