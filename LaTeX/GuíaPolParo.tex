...
\vspace*{-5pt}
\section*{¿Por qué debe haber un paro naciona indefinido para el sector Educativo en el año 2015?}
...
\begin{enumerate}
\item ¿Observa en la lectura de los artículos anteriores alguna vez mencionada la palabra gratuidad?
...
¿Cree Ud, que si actualmente no se cumplen los parámetros, como se observa en nuestra institución, donde los cursos de $6^{\circ}$ y $7^{\circ}$ sobrepasan el parámetro llegando a tener 47 estudiantes, que pasará con estos parámetros establecidos en la norma si por establecer la jornada única sin la infraestructura necesaria se acaben las jornadas tarde? ¿Será lo mismo que un maestro trabaje con 30 estudiante en educación básica o media a que trabaje con cerca de 50 estudiantes? Si esto llegase a ocurrir, tener cerca de 50 estudiantes dejará de ser la excepción para convertirse en la regla.
\end{enumerate}
