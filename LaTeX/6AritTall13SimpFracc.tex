...
\begin{itemize}
\begin{multicols}{3}
\item $\dfrac{1}{4}$ \tikz \draw (0,0)rectangle (.7,.7); $\dfrac{1}{6}$
\item $\dfrac{1}{5}$ \tikz \draw (0,0) rectangle (.7,.7); $\dfrac{1}{3}$
\item $\dfrac{4}{9}$ \tikz \draw (0,0) rectangle (.7,.7); $\dfrac{3}{7}$
\item $\dfrac{7}{8}$ \underline{\hspace{12pt}} $\dfrac{6}{7}$
\item $\dfrac{7}{9}$ \underline{\hspace{12pt}} $\dfrac{8}{11}$ 
\item $\dfrac{4}{10}$ \tikz \draw rectangle (.5,.5); $\dfrac{3}{7}$
\end{multicols}
\end{itemize}
\end{document}
