...
\fbox{\emph{Para recordar:}}
\section*{Casos de factorizaci\'on}
\begin{itemize}
\item Diferencia de cuadrados: $a^{2}-b^{2}=(a-b)(a+b)$
\item Trinomios
\begin{itemize}
\item[i)] $x^{2}+3x-10$.\\En este caso debemos buscar dos números que multiplicados den el tercer término $-10$ y sumados den el coeficiente del segundo término $3$, los cuales son 5 y $-2$. De tal forma que la factorización es: \[x^{2}+3x-10=(x-2)(x+5)\]
