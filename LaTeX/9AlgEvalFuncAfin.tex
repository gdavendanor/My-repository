...
\ExamClass{\includegraphics[height=16pt]{Images/logo-sed.png} Álgebra $11^{\circ}$}
...
\end{center}
\end{minipage}
\item ¿Cuánto deberá pagar un cliente por una llamada de 20 minutos? \noanswer
\item Si se pagara por segundos en vez de pagar por minutos, ¿cuánto deberá pagar un cliente que hable 4 minutos y medio?\noanswer
\end{enumerate}
\newpage
...
\item 3 horas \noanswer
\item 5 horas \noanswer
\item 2 horas y media \noanswer
\end{enumerate}
Ahora encuentra la rapidez media (la pendiente de la recta) del ciclista en kilómetros por hora (km/h) \noanswer
\end{enumerate}
\end{document}
