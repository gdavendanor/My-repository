...
\paragraph*{Solución:} Entre ambos comieron la suma de lo que comió cada uno.
...
\[\dºfrac{1}{4}=\dfrac{1\cdot 2}{4\cdot 2}=\dfrac{2}{8}\qquad \qquad \dfrac{2}{8}+\dfrac{3}{8}=\dfrac{5}{8}\]
\subsubsection*{Ejercicios}
\begin{enumerate}
\begin{multicols}{3}
