...
\begin{enumerate}
\begin{multicols}{3}
\item[f.] $\dfrac{2}{3}+\dfrac{3}{9}$
\item[g.] $\dfrac{4}{12}+\dfrac{1}{48}$
\item[h.] $\dfrac{34}{62}+\dfrac{2}{31}$
\item[i.] $\dfrac{2}{25}+\dfrac{3}{5}$
\item[j.] $\dfrac{13}{360}+\dfrac{7}{18}$
\item[k.] $\dfrac{2}{5}+\dfrac{18}{30}$
\end{multicols}
\end{enumerate}
\end{document}
