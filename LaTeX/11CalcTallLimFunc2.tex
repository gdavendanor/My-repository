...
\begin{minipage}{.6\textwidth}
 ...
 \end{enumerate}
\end{minipage}
\item Determine el valor solicitado, si existe. Si no existe, explique por qué
...
\end{minipage}
\begin{minipage}{.35\textwidth}
 \includegraphics[scale=.75]{./Images/funcionPto16.png}
% funcionPto16.png: 0x0 pixel, 300dpi, 0.00x0.00 cm, bb=
\end{minipage}
\end{enumerate}
\end{document}
