...
\begin{minipage}{.95\textwidth}
 \fbox{\emph{Para cierto valor de una característica de una población o una muestra, la frecuencia acumulada relativa se calcula mediante el cociente de la frecuencia acumulada del dato y el número total de datos.}}
\end{minipage}
