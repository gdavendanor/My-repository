...
\begin{minipage}{.4\textwidth}
  \includegraphics[scale=.9]{Images/funcion-h.png}
\end{minipage}
\begin{minipage}{.4\textwidth}
  \includegraphics[scale=.9]{Images/funcion-g.png}
\end{minipage}\hfill
...
\begin{minipage}{.35\textwidth}
  \includegraphics[scale=.9]{Images/funcion-f-g.png}
\end{minipage}
  \begin{minipage}{.4\textwidth}
    \includegraphics[scale=.9]{Images/funcion-3.png}
  \end{minipage}\hfill
  \begin{minipage}{.5\textwidth}
