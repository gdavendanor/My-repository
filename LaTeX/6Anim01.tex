...
\fancyhead[RE]{}
\fancyhead[RO]{\textit{Germán Avendaño Ramírez, Lic. U.D., M.Sc. U.N.}}
\fancyhead[LO]{}

\author{Alicia Jiménez Velandia\thanks{Diseñado por Germán Avendaño Ramírez, Lic. U.D., M.Sc. U.N., para el área de Matemáticas}}
...
\begin{document}
\maketitle
Nombre: \hrulefill Curso: \underline{\hspace*{30pt}} Fecha: \underline{\hspace*{2.5cm}}
...
% \draw (5,-1)--(6,-1)--(7,0)--(4,0)--(5,-1)--(3,-2)--(2,-3)--(2,-5)--(5,-5)--(5,-8)--(3,-9)--(8,-9)--(6,-8)--(6,-5)--(9,-5)--(9,-3)--(8,-2)--(6,-1);
\end{tikzpicture}
\end{center}
\end{document}
