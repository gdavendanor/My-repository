...
\item  Ubique en el plano cartesiano los puntos $A(-3,5)$, $B(2,5)$, $C(2,-4)$ correspondientes a los vértices de un rectángulo. Encuentre las coordenadas del cuarto vértice $D$ y ubíquelo también en el plano. Haga el dibujo del rectángulo y especifique en qué cuadrante se encuentra cada uno de los vértices.
\end{minipage}
