...
\begin{enumerate}
\begin{multicols}{2}
\item $\frac{7}{9}$, $\frac{7}{8}$, $\frac{7}{3}$, $\frac{7}{2}$, $\frac{7}{10}$, $\frac{7}{12}$
\item $\frac{3}{4}$, $\frac{5}{12}$, $\frac{5}{3}$, $\frac{1}{6}$, $\frac{7}{12}$
\end{multicols}
\end{enumerate}\noanswer[.25in]
\item Realice las siguientes operaciones y simplifique si es posible:
\begin{enumerate}
\begin{multicols}{2}
\item $\frac{3}{5}+\frac{7}{10}=$
\item $\frac{7}{9}-\frac{5}{12}=$
\end{multicols}\noanswer[.1in]
\begin{multicols}{2}
\item $\frac{3}{7}+\frac{2}{3}-\frac{4}{21}=$
\item $\frac{3}{2}\cdot \frac{3}{4}\cdot\frac{4}{5}=$
\end{multicols}\noanswer[.1in]
\begin{multicols}{2}
\item $\frac{7}{12}\div \frac{5}{8}=$\noanswer
\item $7\div\frac{3}{5}\cdot\frac{3}{4}\cdot\frac{2}{3}=$\noanswer
\end{multicols}
\end{enumerate}
