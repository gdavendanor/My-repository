...
Esta prueba consta de preguntas tipo I (selección múltiple con única respuesta). Marque la respuesta que considere correcta en el cuadro de respuestas dado. Haga las operaciones en una hoja aparte. \textit{\textbf{NO} dañe ni marque este material}}}}
\end{center}
%\vspace{0.1in}
%\makebox[\textwidth]{Nombres, curso y fecha:\enspace\hrulefill}
\vspace{0.2in}
%\makebox[\textwidth]{Prof: Germán Avendaño Ramírez, Lic en Mat U.D., M.Sc. U.N.}
\begin{multicols}{2}
