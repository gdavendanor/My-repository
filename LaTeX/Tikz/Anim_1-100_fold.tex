...
\usepackage[papersize={8.5in,13in},top=1cm,bottom=1cm,right=1cm,left=1cm]{geometry}
\usepackage[spanish,es-noshorthands]{babel}
\usepackage{tikz,pgf}
\usepackage{multicol}
\begin{document}
\begin{multicols}{2}
Curso: \underline{\hspace*{30pt}} Nombre: \underline{\hspace*{5cm}}
\begin{center}
Fecha: \underline{\hspace*{90pt}}
\end{center}
\begin{center}
