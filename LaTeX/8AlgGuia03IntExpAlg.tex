...
\begin{enumerate}
\item El doble de un número $n$ es \ldots R: $2\cdot n$
...
\begin{enumerate}
El cuadrado de un número disminuido en 25
b) El siguiente número del número p
c) El número anterior al número p
d) El cuadrado de un número más el cuadrado de otro
número
e) La mitad de un número menos el tripe de otro número
f) La diferencia entre el doble de un número y la mitad
de otro número
