...
\draw [color=cqcqcq,dash pattern=on 2pt off 2pt, xstep=1.0cm,ystep=1.0cm] (-3,-3) grid (3,4);
...
\draw[domain=-3.0:1.0] plot(\x,{-\x*\x+4});
\draw[domain=1.0:3.2600000000000007] plot(\x,{(\x)+1});
