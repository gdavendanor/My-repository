...
\begin{enumerate}
 ...
 \item Si el perímetro del rectángulo \tikz \draw (0,0)--node[]{$x$}(3,0)--node[right]{5}(3,1)--(0,1)--cycle; mide 40, entonces $x+10=$?
 \item El quíntuple de 7
 \item $7\times8-3^{1}=$
 \item Número cuya dos cifras suman 9 y cuyo producto es 45 y está entre 50 y 99.
\end{enumerate}
