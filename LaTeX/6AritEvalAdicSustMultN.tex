...
\begin{enumerate}
  ...
  \item Encuentre el valor de $x$ apropiado en cada caso:
  \begin{enumerate}
  \begin{multicols}{2}
    \item $x+12=25$ \qquad $x=$\underline{\hspace*{36pt}}
  \item $12+x=23$ \qquad $x=$\underline{\hspace*{36pt}}
  \item $8+x=8$ \qquad $x=$\underline{\hspace*{36pt}}
  \item $(4+x)+15=30$ \qquad $x=$\underline{\hspace*{36pt}}
  \end{multicols}
  \end{enumerate}
