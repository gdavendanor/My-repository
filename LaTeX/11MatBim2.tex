...
\question La siguiente gráfica muestra la relación entre la velocidad de un molino y el tiempo de fun-
cionamiento en un día.
\end{minipage}\hfill
\begin{minipage}{.5\textwidth}
\includegraphics[scale=1]{Images/velocida_molino.png} 
\end{minipage}
\end{questions}
%cuadro de puntajes
%\begin{center}
