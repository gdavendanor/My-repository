...
\begin{enumerate}
 \item $\dfrac{4}{5}+\left(\dfrac{-3}{7}\right)=$\noanswer
\item $\dfrac{3}{5}-\dfrac{2}{9}=$\noanswer
\item $\dfrac{3}{4}\cdot\left(\dfrac{-1}{5}\right)=$\noanswer
\item $\dfrac{2}{5}\div\left(\dfrac{-5}{3}\right)=$\noanswer
\item $\dfrac{5\left(\frac{3}{5}\right)+2\left(\frac{-2}{8}\right)}{\frac{7}{5}\left(\frac{-1}{5}\right)-\frac{3}{4}\left(\frac{-4}{5}\right)}=$\noanswer
\end{enumerate}
\item Solucione la ecuación \qquad $x+\dfrac{2}{5}=8$\noanswer
...
\item $0,\overline{69}$ \noanswer
\end{enumerate}
\item Ubique en la recta numérica el número $\dfrac{2}{5}$
\begin{center}
