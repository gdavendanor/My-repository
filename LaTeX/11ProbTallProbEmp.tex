...
\author{Germ\'an Avenda\~no Ram\'irez, \thanks{Lic. U.D., M.Sc. U.N., Email: matematicas.german@gmail.com}}
...
\end{enumerate}
 \end{enumerate}
\section*{Acerca de la película ``La sociedad de los poetas muertos``}
\subsection*{Cuestionario}
\begin{enumerate}
 \item Haga una breve síntesis del argumento de la película
 \item ¿Con cuál personaje de la película te identificas más y por qué?
 \item ¿Crees que fue acertado el comportamiento de ''Nuwanda``? ¿Por qué?
 \item Haga una lista de los personajes más relevantes de la película
 \item ¿Qué fué lo que más le impactó de la película?
 \item ¿Qué enseñanza te deja esta película?
\end{enumerate}
\emph{Entregar este trabajo el día lunes 8 de septiembre a la entrada del colegio en hoja examen. En una misma hoja el taller de probabilidad y el cuestionario sobre la película}

\emph{Recuerde que el jueves 11 de septiembre se hará la evaluación bimestral de matemáticas}
