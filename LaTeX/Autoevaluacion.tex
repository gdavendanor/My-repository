...
Queridos estudiantes, deben evaluarse cada aspecto en una escala de 1-5 en el espacio asignado, de acuerdo a lo siguiente:\\
...
\answerline
\end{questions}
Ahora en la siguiente tabla, sume los puntajes que haya obtenido en cada página de este autoevaluación y luego sume estos dos puntajes para obtener su puntaje total.
\begin{center}
\gradetable[h][pages]
\end{center}
Ahora pida a un compañero que haga una heteroevaluación y la consigne al lado de sus respuestas y para que consigne en la siguiente tabla:
\begin{center}
 \gradetable[h][pages]
\end{center}
