...
\date{}http://start.ubuntu.com/12.04/Google/?sourceid=hp
\maketitle
\begin{center}
...
\answerline
\end{questions}
Ahora en la siguiente tabla, sume los puntajes que haya obtenido en cada página de este examen y luego sume estos dos puntajes para obtener su puntaje total.
\begin{center}
\gradetable[h][pages]
\end{center}
\end{document}