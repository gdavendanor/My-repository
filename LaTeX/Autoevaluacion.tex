...
\usepackage[left=1.3cm,top=1.5cm,bottom=1.75cm,right=1.3cm]{geometry}
...
\author{Germ\'an Avendaño Ram\'irez~\thanks{Lic. Mat. U.D., M.Sc. U.N.}\\Colegio Arborizadora Baja I.E.D.}
\date{}
\maketitle
\begin{center}
...
\end{center}
\vspace{0.1in}
\makebox[\textwidth]{Nombre Autoevaluado \underline{\hspace*{9cm}} Fecha: \enspace\hrulefill}\\ \\
\makebox[\textwidth]{curso:\underline{\hspace*{1.5cm}} Nombre coevaluador: \hrulefill}
\begin{questions}
\question[5]
