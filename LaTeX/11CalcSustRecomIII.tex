...
\vsize=8.7truein
\definecolor{cqcqcq}{rgb}{0.75,0.75,0.75}
\tikzpicture[scale=.25,line cap=round,line join=round,x=1.0cm,y=1.0mm]
\draw [color=cqcqcq,dash pattern=on 255pt off 255pt, xstep=1.0cm,ystep=200.0cm] (-0.34,-5) grid (6.5,1205);
