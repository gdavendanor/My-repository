...
\usepackage{multicol}
\usepackage{subfig}
\usepackage[papersize={6.5in,8.5in},total={5.8in,7.25in},centering]{geometry}
\usepackage{fancyhdr}
\pagestyle{fancy}
...
%\item ¿Qué figura se formaría si los caballos dan una vuelta completa y dejan huellas por donde pasan?
\end{enumerate}
\end{enumerate}
\end{document}
